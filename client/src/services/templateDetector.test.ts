...
describe('detectTemplate', () => {
  ...
  describe('edge cases', () => {
    ...
    it('скарга має пріоритет над звільненням (оскарження наказу)', () => {
      const текст = 'Звільнення можна оскаржити';
      expect(detectTemplate(текст)).toBe('skarga');
    });

    it('скарга має пріоритет над невиплатою коли є оскарження', () => {
