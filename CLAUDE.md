...
11 документів, ~1955 чанків — покривають ~95% типових питань:
...
6. «Про відпустки» — щорічні, додаткові, навчальні відпустки
7. Закон №3633-IX (зміни щодо мобілізації від 11.04.2024) — оновлення обліку, мобілізації, служби
...
### 2. Верифікація цитат (анти-галюцінація)
Змусити Claude повертати цитати як структуровані дані `{answer, citations: [{article, quote}]}`. Програмно перевіряти кожну цитату проти наданих чанків. Видаляти вигадані цитати. Це найсильніший захист від галюцінацій для юридичного AI.

### 3. Golden test set (оцінка якості)
Створити набір з 50+ пар [питання → очікувана стаття + відповідь]. Автоматично вимірювати: retrieval recall, citation accuracy, faithfulness. Використати RAGAS framework. Без цього неможливо обʼєктивно оцінити чи зміни покращують якість.
...
Для неясних запитів ("мені не платять") — спочатку попросити Claude написати гіпотетичну відповідь, потім шукати по ембеддингу цієї відповіді. Гіпотеза ближча в просторі ембеддингів до реальних чанків, ніж коротке питання.
