...
- [ ] Створити `server/src/__tests__/feedback.test.ts`
- [ ] Тест: повертає 503 якщо SMTP не налаштований
- [ ] Тест: повертає 400 якщо повідомлення пусте або коротке
- [ ] Тест: повертає 400 якщо повідомлення довше 5000 символів
- [ ] Тест: повертає 400 якщо PDF більше 5MB
- [ ] Тест: успішна відправка з моком nodemailer
- [ ] Тест: успішна відправка з PDF вкладенням
- [ ] Тест: повертає 500 при помилці SMTP
- [ ] Додати runtime валідацію `type` (допустимі: 'good', 'bad', 'suggestion', default: 'suggestion')
