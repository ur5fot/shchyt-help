...
- [x] Запустити `npm run eval` — зафіксувати нові метрики
- [x] Порівняти recall до і після re-ranking
- [x] Якщо recall погіршився — діагностувати та виправити
- [x] Оновити eval golden set якщо потрібно (деякі expectedChunks можуть бути неточними)

### Task 4: Оптимізація та документація
- [x] Перевірити час відповіді — re-ranking не має додавати більше 1-2 секунди
- [x] Якщо повільно — розглянути кешування або меншу модель
- [x] Оновити `CLAUDE.md` — додати опис re-ranking
- [x] Позначити re-ranking як реалізований у розділі "Плановані покращення"
- [x] `npm test` — всі тести проходять
