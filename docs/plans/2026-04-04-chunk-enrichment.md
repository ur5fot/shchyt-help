...
- [ ] Додати rate limiting — не більше 10 запитів/сек до Claude API
- [ ] Додати graceful resume — якщо summary вже є, пропустити чанк
- [ ] Написати тест для парсингу відповіді та запису в JSON
